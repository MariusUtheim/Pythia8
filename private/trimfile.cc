...
string replaceOld[4] = { "Copyright (C) 2018", "GNU GPL version 2",
  "\"true\"", "\"false\"" }; 
string replaceNew[4] = { "Copyright (C) 2019", "GNU GPL v2 or later",
  "\"on\"",   "\"off\"" };
int    replaceLen[4] = { 18, 17, 6, 7 };
