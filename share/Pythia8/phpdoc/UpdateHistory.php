...
<ol id="toc">
  <li><a href="#section0">8.241: 21 March 2019</a></li>
...
<li>Static code analysis by Dmitri Konstantinov, Grigory ?? and 
Ivan Razumov revealed four errors, now fixed. 
<ul> 
...
including improved kinematics and elastic production of VMD states 
including the <i>J/Psi</i>.</li> 
 
<li>New class <code>LowEnergyHadHad</code> for the hadronization of 
low-energy collisions between two hadrons. To be used e.g. within 
the modelling of hadronic rescattering in the final state of high-energy 
collisions, but this framework is still under development.</li> 
